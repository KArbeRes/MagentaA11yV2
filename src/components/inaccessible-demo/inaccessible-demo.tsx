...
const InaccessibleDemo: React.FC = () => {
  return (
    ...
    <div className="container section group-4">
        ...
        <div className="h-bravo">
            Common questions
        </div>

        <div className="expander-group">
            <div className="button expander-toggle" aria-expanded="false" role="application">
        ...
        <div className="expander-group">
            ...
            <div className="expander-group">
                ...
                <div className="expander-content">
                    <img src="/assets/images/examples/screenreader-browser-pairing.png" alt="image of screenreader browser pairings" />
                </div>  
            </div>
        </div>
